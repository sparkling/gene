...
|----------|--------------|
| [43-51-PHARMACEUTICALS](./43-51-PHARMACEUTICALS.md) | Sister document for pharma interventions |
| [43-53-TARGETS-LINKING](./43-53-TARGETS-LINKING.md) | Compound-target-pathway integration |
| [43-41-PATHWAYS-PRIMARY](./43-41-PATHWAYS-PRIMARY.md) | Pathway databases for target enrichment |
| [43-21-TCM](./43-21-TCM.md) | TCM-specific databases |
| [43-22-AYURVEDA](./43-22-AYURVEDA.md) | Ayurveda-specific databases |
