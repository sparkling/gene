...
|----------|--------------|
| [43-00-INDEX.md](./43-00-INDEX.md) | Parent navigation index |
| [43-11-GENETICS-PRIMARY.md](./43-11-GENETICS-PRIMARY.md) | Shared variant databases (ClinVar, dbSNP) |
| [43-12-GENETICS-POPULATION.md](./43-12-GENETICS-POPULATION.md) | Population frequency data (gnomAD) |
| [43-51-PHARMACEUTICALS.md](./43-51-PHARMACEUTICALS.md) | Pharmacogenomics overlap (PharmGKB, CPIC) |
| [43-75-RARE-DISEASES.md](./43-75-RARE-DISEASES.md) | Rare disease overlap (Orphanet, DECIPHER) |
| [44-ARCHITECTURE.md](../44-ARCHITECTURE.md) | Informs controlled access data handling |
| [45-DATA-MODEL.md](../45-DATA-MODEL.md) | Informs entity relationships |
