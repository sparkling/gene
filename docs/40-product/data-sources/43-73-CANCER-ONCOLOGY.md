...
|----------|--------------|
| [43-11-GENETICS-PRIMARY](./43-11-GENETICS-PRIMARY.md) | ClinVar also covered there (germline focus) |
| [43-43-PATHWAYS-DISEASE](./43-43-PATHWAYS-DISEASE.md) | Disease ontology linking |
| [43-51-PHARMACEUTICALS](./43-51-PHARMACEUTICALS.md) | Drug-variant associations |
