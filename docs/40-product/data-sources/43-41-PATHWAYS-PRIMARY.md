...
|----------|--------------|
| [43-00-INDEX](./43-00-INDEX.md) | Parent index |
| [43-42-PATHWAYS-METABOLISM](./43-42-PATHWAYS-METABOLISM.md) | Detailed metabolic pathway coverage |
| [43-43-PATHWAYS-DISEASE](./43-43-PATHWAYS-DISEASE.md) | Disease pathway databases |
| [43-51-PHARMACEUTICALS](./43-51-PHARMACEUTICALS.md) | Drug database integration |
| [43-53-TARGETS-LINKING](./43-53-TARGETS-LINKING.md) | Compound-target-pathway linking strategy |
| [45-DATA-MODEL](../45-DATA-MODEL.md) | Entity structure informs pathway table design |
| [44-ARCHITECTURE](../44-ARCHITECTURE.md) | Graph database selection (Neo4j for Reactome) |
