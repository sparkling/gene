...
status: active
migrated_from: databases/
tags: [reference, catalogs, database-selection, comparison]
---

# Database Catalogs

**Parent:** [Reference](../_index.md)

Comprehensive database catalogs with detailed specifications, comparisons, and selection guides. These documents provide in-depth information about 100+ databases across all categories, including URLs, licensing, schema details, and integration recommendations.

**Note:** Summary "Database Selection Guide" sections have been integrated into the relevant [resource/](../../resource/) subcategory indexes. These catalogs contain the full detailed documentation.
