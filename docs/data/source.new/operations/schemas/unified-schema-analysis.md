---
id: schemas-unified-schema-analysis
...
|------|------------|---------|
| `hub_identifier` | Canonical identifier chosen to connect data across databases | InChIKey for compounds |
| `entity` | Core data object type in the unified schema | Gene, Variant, Compound |
| `association_table` | Junction table linking two or more entities with evidence | VariantDiseaseAssociation |
| `cardinality` | Relationship multiplicity between entities | N:M (many-to-many) |
| `normalization` | Process of standardizing data formats and identifiers | Mapping rsID to SPDI |
| `provenance` | Origin and evidence trail for data assertions | Publication PMID, database version |
| `evidence_type` | Category of supporting data for an association | Experimental, computational, literature |
| `canonical_id` | Preferred identifier for cross-database mapping | NCBI Gene ID for genes |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| SPDI | Sequence-Position-Deletion-Insertion variant notation | Variant normalization |
| HGVS | Human Genome Variation Society nomenclature | Variant naming |
| InChIKey | 27-character hash of InChI structure identifier | Compound identity |
| MONDO | Mondo Disease Ontology for unified disease concepts | Disease mapping |
| UniProt | Universal Protein Resource for protein identifiers | Protein identity |
| Reactome | Curated pathway database with reaction-level detail | Pathway identity |
...
| OMIM | Online Mendelian Inheritance in Man | Disease genetics |
| HPO | Human Phenotype Ontology | Phenotype terms |
| EFO | Experimental Factor Ontology | GWAS traits |
| UMLS | Unified Medical Language System | Vocabulary integration |
| CUI | Concept Unique Identifier | UMLS term |
| ADMET | Absorption, Distribution, Metabolism, Excretion, Toxicity | Drug properties |
| NP | Natural Product | Compound classification |
