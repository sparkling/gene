---
id: schema-foodb
title: "FooDB - Schema Documentation"
type: schema
parent: _index.md
...
|------|------------|---------|
| `food_id` | Primary key identifier for a food item in the database | `234` |
| `public_id` | Human-readable food identifier with FOOD prefix | `FOOD00234` |
| `compound_id` | Identifier for chemical compounds with FDB prefix | `FDB000001` |
| `source_type` | Indicates whether content record links to Compound or Nutrient | `Compound` |
| `orig_content` | Measured or average concentration of a compound in food | `25.3` |
| `orig_unit` | Unit of measurement for compound concentration | `mg/100g` |
| `moldb_smiles` | SMILES notation representing molecular structure | `CC(=O)Oc1ccccc1C(=O)O` |
| `moldb_inchikey` | Unique identifier for chemical substances | `BSYNRYMUTXBXSQ-UHFFFAOYSA-N` |
| `cas_number` | Chemical Abstracts Service registry number | `7084-24-4` |
| `export` | Status indicator (1=active, 2=inactive) for compound records | `1` |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| Polyphenols | Large class of plant compounds including flavonoids and phenolic acids | compound classification |
| Terpenoids | Diverse class of natural products derived from isoprene units | compound classification |
| Macronutrient | Essential nutrients needed in large quantities (carbs, proteins, fats) | nutrient classification |
| Micronutrient | Essential nutrients needed in small quantities (vitamins, minerals) | nutrient classification |
| Phytochemical | Chemical compound produced by plants with biological activity | compound source |
| Food Group | High-level categorization of foods by type | `Herbs and Spices` |
| Food Subgroup | Secondary categorization within a food group | `Herbs` |
...
| HMDB | Human Metabolome Database | Related metabolite database |
| USDA SR | USDA Standard Reference | Nutrient database |
| ITIS | Integrated Taxonomic Information System | Species classification |
| IUPAC | International Union of Pure and Applied Chemistry | Chemical nomenclature authority |
...
- [sleep-longevity-nutri.md](../diseases/sleep-longevity-nutri.md) - References FooDB
- [natural-products.md](../compounds/natural-products.md) - Natural product databases
