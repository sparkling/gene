---
id: integration-integration-guide
title: "Data Integration Guide: Traditional Medicine → Genes → Pathways"
type: integration
parent: ../_index.md
...
|------|------------|---------|
| Data Integration | Combining data from multiple sources into a unified view | Merging TCM + pathway data |
| API Endpoint | URL where an API can be accessed | `/api/v2/compounds` |
| Rate Limiting | Restriction on number of API requests per time period | 10 requests/second |
...
| WikiPathways | Community-curated pathway database | Open pathway data |
...
| DSLD | Dietary Supplement Label Database | Supplement information |
