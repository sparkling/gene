---
id: domain-autoimmune
title: "Autoimmune & Hormone Disease Databases"
type: health-domain
parent: ../_index.md
...
|------|------------|---------|
| `SNP` | Single Nucleotide Polymorphism - a variation at a single position in a DNA sequence | rs2228570 |
| `GWAS` | Genome-Wide Association Study - examines genetic variants across entire genomes to find disease associations | ThyroidOmics GWAS |
| `eQTL` | Expression Quantitative Trait Locus - genomic locus explaining variation in gene expression | GTEx eQTL data |
| `GraphQL` | Query language for APIs providing flexible data retrieval | gnomAD GraphQL API |
| `VCF` | Variant Call Format - standard file format for storing gene sequence variations | PharmVar VCF files |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| `HLA` | Human Leukocyte Antigen - genes encoding MHC proteins critical for immune function | IPD-IMGT/HLA database |
| `KIR` | Killer Immunoglobulin-like Receptor - NK cell receptors that interact with HLA | IPD-KIR database |
| `TSH` | Thyroid Stimulating Hormone - pituitary hormone regulating thyroid function | ThyroidOmics traits |
| `FT4` | Free Thyroxine - unbound thyroid hormone in blood | Thyroid function marker |
| `Autoimmune` | Immune system attacking the body's own tissues | RA, SLE, T1D, MS |
| `Steroid metabolism` | Biochemical pathways for hormone synthesis and breakdown | Reactome R-HSA-196071 |
| `CYP enzymes` | Cytochrome P450 enzymes involved in steroid and drug metabolism | CYP11A1, CYP17A1 |

### Acronyms

| Acronym | Expansion | Notes |
|---------|-----------|-------|
| HLA | Human Leukocyte Antigen | MHC system in humans |
| KIR | Killer Immunoglobulin-like Receptor | NK cell receptors |
| IPD-IMGT | Immuno Polymorphism Database - ImMunoGeneTics | WHO HLA nomenclature |
| GWAS | Genome-Wide Association Study | Variant-trait associations |
| gnomAD | Genome Aggregation Database | Population frequencies |
| TCGA | The Cancer Genome Atlas | Cancer genomics project |
| THCA | Thyroid Carcinoma | TCGA thyroid cancer project |
| GDC | Genomic Data Commons | NCI data portal |
| RA | Rheumatoid Arthritis | Autoimmune joint disease |
| SLE | Systemic Lupus Erythematosus | Autoimmune systemic disease |
| T1D | Type 1 Diabetes | Autoimmune diabetes |
| MS | Multiple Sclerosis | Autoimmune neurological disease |
| IBD | Inflammatory Bowel Disease | Includes Crohn's and UC |
| UC | Ulcerative Colitis | Form of IBD |
| PharmVar | Pharmacogene Variation Consortium | CYP nomenclature |
| KEGG | Kyoto Encyclopedia of Genes and Genomes | Pathway database |
| CC BY | Creative Commons Attribution | Open license type |
| CC BY-ND | Creative Commons Attribution-NoDerivs | License restricting modifications |
...
| [primary.md](./../genetics/primary.md) | Overlaps with dbSNP, ClinVar |
| [primary.md](./../pathways/primary.md) | Overlaps with Reactome |
| [pharmaceuticals.md](./../compounds/pharmaceuticals.md) | Overlaps with PharmVar |
