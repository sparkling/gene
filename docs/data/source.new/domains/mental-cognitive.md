---
id: domain-mental-cognitive
title: "Mental Health & Cognitive Data Sources"
type: health-domain
parent: ../_index.md
...
|------|------------|---------|
| `GWAS` | Genome-Wide Association Study - statistical approach to identify genetic variants associated with traits across entire genomes | PGC schizophrenia GWAS with 300K+ participants |
| `eQTL` | Expression quantitative trait locus - genetic variant that affects gene expression levels | GTEx brain tissue eQTL data |
| `DAC` | Data Access Committee - group that reviews and approves requests for controlled-access data | PGC DAC for individual-level data |
| `DAR` | Data Access Request - formal application to access controlled datasets | dbGaP DAR for psychiatric cohorts |
| `GraphQL` | Query language for APIs allowing clients to request exactly the data they need | GTEx API V2 uses GraphQL |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| `Nootropic` | Compound that enhances cognitive function including memory, creativity, or motivation | ChEBI:66980 classification |
| `Neurotransmitter` | Chemical messenger that transmits signals across synapses between neurons | Dopamine, serotonin, GABA |
| `Synapse` | Junction between two neurons where signal transmission occurs | SynGO annotations |
| `Chronotype` | Behavioral manifestation of circadian rhythms - morning vs. evening preference | Sleep GWAS phenotypes |
| `Circadian rhythm` | Internal 24-hour cycle regulating sleep-wake patterns and physiological processes | CLOCK, PER1-3, CRY1-2 genes |
| `AChE` | Acetylcholinesterase - enzyme that breaks down acetylcholine neurotransmitter | Target for cognitive drugs (donepezil) |
| `SNP heritability` | Proportion of phenotypic variance explained by common genetic variants | COGENT: 21.5% for cognitive function |

### Acronyms

| Acronym | Expansion | Notes |
|---------|-----------|-------|
| PGC | Psychiatric Genomics Consortium | Largest psychiatric genetics resource |
| NIMH | National Institute of Mental Health | Part of NIH |
| NRGR | NIMH Genetics Repository | Sample and data repository |
| GTEx | Genotype-Tissue Expression | 13 brain regions with eQTL |
| ChEMBL | Chemical database from EMBL-EBI | 2.4M+ compounds |
| ChEBI | Chemical Entities of Biological Interest | Chemical ontology |
| KEGG | Kyoto Encyclopedia of Genes and Genomes | Pathway database |
| SynGO | Synaptic Gene Ontology | 1,100+ synaptic genes |
| COGENT | Cognitive Genomics Consortium | Cognitive GWAS meta-analysis |
| CNCR | Center for Neurogenomics and Cognitive Research | VU Amsterdam |
| CC BY-SA | Creative Commons Attribution-ShareAlike | ChEMBL license |
| CC0 | Creative Commons Zero (public domain) | Reactome, ChEBI licenses |
| CC BY 4.0 | Creative Commons Attribution 4.0 | GO, SynGO licenses |
| ADHD | Attention Deficit Hyperactivity Disorder | PGC phenotype |
| OCD | Obsessive-Compulsive Disorder | PGC phenotype |
| PTSD | Post-Traumatic Stress Disorder | PGC phenotype |
| NMDA | N-Methyl-D-Aspartate | Glutamate receptor subtype |
| ISH | In Situ Hybridization | Allen Brain Atlas technique |
| MNI | Montreal Neurological Institute | Brain coordinate space |
