---
id: domain-cardio-metabolic
title: "Cardiovascular and Metabolic Data Sources"
type: health-domain
parent: ../_index.md
...
|------|------------|---------|
| `SNP` | Single Nucleotide Polymorphism - a variation at a single position in a DNA sequence | rs7903146 |
| `Summary statistics` | Aggregated GWAS results including effect sizes and p-values without individual data | GLGC lipid GWAS |
| `Meta-analysis` | Statistical method combining results from multiple studies | CARDIoGRAMplusC4D |
| `Odds ratio` | Measure of association between variant and disease risk | CAD association strength |
| `Heritability` | Proportion of phenotypic variation attributable to genetics | SNP heritability 10.2% for pain |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| `CAD` | Coronary Artery Disease - atherosclerotic heart disease | CARDIoGRAMplusC4D consortium |
| `HDL-C` | High-Density Lipoprotein Cholesterol - "good" cholesterol | GLGC lipid traits |
| `LDL-C` | Low-Density Lipoprotein Cholesterol - "bad" cholesterol | GLGC lipid traits |
| `TG` | Triglycerides - blood fat associated with cardiovascular risk | GLGC lipid traits |
| `T2D` | Type 2 Diabetes - metabolic disease with insulin resistance | DIAGRAM consortium |
| `BMI` | Body Mass Index - weight-to-height ratio for obesity assessment | GIANT consortium |
| `Metabolomics` | Study of small molecule metabolites in biological systems | HMDB, Metabolomics Workbench |

### Acronyms

| Acronym | Expansion | Notes |
|---------|-----------|-------|
| CARDIoGRAMplusC4D | Coronary ARtery DIsease Genome-wide Replication And Meta-analysis plus Coronary Artery Disease Genetics | CAD GWAS consortium |
| GLGC | Global Lipids Genetics Consortium | Lipid trait GWAS, 923 loci |
| DIAGRAM | DIAbetes Genetics Replication And Meta-analysis | T2D GWAS consortium |
| DIAMANTE | DIAbetes Meta-ANalysis of Trans-Ethnic | Multi-ancestry T2D GWAS |
| T2DGGI | Type 2 Diabetes Global Genomics Initiative | Latest T2D GWAS (2024) |
| GIANT | Genetic Investigation of ANthropometric Traits | BMI/height GWAS consortium |
| ICBP | International Consortium for Blood Pressure | Blood pressure GWAS |
| HMDB | Human Metabolome Database | 220K+ metabolites |
| SBP | Systolic Blood Pressure | Top number in BP reading |
| DBP | Diastolic Blood Pressure | Bottom number in BP reading |
| WHR | Waist-Hip Ratio | Body fat distribution measure |
| OpenGWAS | Open GWAS database at MRC IEU | 50K+ GWAS datasets |
| EBI | European Bioinformatics Institute | GWAS Catalog host |
...
|----------|--------------|
| [_index.md](./_index.md) | Parent index document |
| [primary.md](./../genetics/primary.md) | Related genetics sources |
