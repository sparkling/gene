---
id: domain-allergy-pain
title: "Allergy, Histamine & Pain Genetics Databases"
type: health-domain
parent: ../_index.md
...
|------|------------|---------|
| `SNP` | Single Nucleotide Polymorphism - a variation at a single position in a DNA sequence | rs6746030 |
| `GWAS` | Genome-Wide Association Study - examines genetic variants across entire genomes to find disease associations | UK Biobank Pain GWAS |
| `rsID` | Reference SNP cluster ID - unique identifier for a SNP in dbSNP | rs1801133 |
| `VCF` | Variant Call Format - standard file format for storing gene sequence variations | clinvar.vcf.gz |
| `REST API` | Representational State Transfer Application Programming Interface - web service for data access | GWAS Catalog REST API |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| `Histamine intolerance` | Reduced ability to metabolize histamine due to enzyme deficiency | DAO, HNMT genes |
| `MCAS` | Mast Cell Activation Syndrome - inappropriate mast cell activation causing systemic symptoms | KIT, TPSAB1 genes |
| `HLA` | Human Leukocyte Antigen - genes encoding immune system proteins for antigen presentation | IPD-IMGT/HLA database |
| `Allergen` | Substance capable of inducing an IgE-mediated immune response | Allergome database |
| `Inflammasome` | Multiprotein complex mediating inflammatory responses | Reactome pathway R-HSA-622312 |
| `DAO` | Diamine Oxidase - enzyme that metabolizes histamine in the gut | AOC1 gene |
| `HNMT` | Histamine N-Methyltransferase - enzyme that metabolizes histamine intracellularly | HNMT gene |

### Acronyms

| Acronym | Expansion | Notes |
|---------|-----------|-------|
| GWAS | Genome-Wide Association Study | Primary method for identifying disease-variant associations |
| HLA | Human Leukocyte Antigen | Major histocompatibility complex in humans |
| MCAS | Mast Cell Activation Syndrome | Related to mastocytosis |
| HPGDB | Human Pain Genes Database | Primary pain genetics resource |
| IPD-IMGT | Immuno Polymorphism Database - ImMunoGeneTics | WHO HLA nomenclature database |
| IUIS | International Union of Immunological Societies | Allergen nomenclature authority |
...
| EBI | European Bioinformatics Institute | Hosts GWAS Catalog |
| NHGRI | National Human Genome Research Institute | Co-hosts GWAS Catalog |
...
| [autoimmune.md](./autoimmune.md) | Overlaps with HLA, autoimmune GWAS |
| [primary.md](./../pathways/primary.md) | Overlaps with Reactome |
| [pharmaceuticals.md](./../compounds/pharmaceuticals.md) | Overlaps with PharmGKB |
