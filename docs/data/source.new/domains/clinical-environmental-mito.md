---
id: clinical-environmental-mito
title: Environmental & Mitochondrial Data Sources
type: clinical
parent: ../_index.md
last_updated: 2026-01-22
status: migrated
tags: [clinical, environmental, mitochondrial, toxicology, ctd, mitomap, detoxification]
---
...
|------|------------|---------|
| `toxicogenomics` | Study of how toxins affect gene expression and function | Chemical-gene interactions |
| `xenobiotic` | Foreign chemical substance not normally found in the body | Drugs, pollutants |
| `biotransformation` | Metabolic conversion of xenobiotics by enzymes | Phase I/II metabolism |
| `haplogroup` | Group of similar mtDNA sequences sharing a common ancestor | Haplogroup H, L, M |
| `heteroplasmy` | Presence of multiple mtDNA variants within a cell | 30% mutant mtDNA |
| `homoplasmy` | All mtDNA copies identical within a cell | 100% wild-type |
| `SNV` | Single nucleotide variant in DNA sequence | m.3243A>G |
| `tetramer` | Four-way relationship in CTD (chemical-gene-phenotype-disease) | Exposure pathway |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| CTD | Comparative Toxicogenomics Database linking chemicals to genes and diseases | Toxicogenomics |
| CompTox | EPA Computational Toxicology Dashboard for environmental chemicals | Exposure data |
| MITOMAP | Human Mitochondrial Genome Database for mtDNA variants | Mitochondrial |
| MSeqDR | Mitochondrial Disease Sequence Data Resource with mvTool API | mtDNA analysis |
| HmtDB | Human Mitochondrial Database with population data | mtDNA sequences |
| T3DB | Toxin and Toxin Target Database | Toxin-target links |
| Reactome | Curated biological pathway database | Detox pathways |
| CYP450 | Cytochrome P450 enzyme family for Phase I metabolism | Drug metabolism |
| Phase_I | Oxidation/reduction reactions introducing functional groups | CYP enzymes |
| Phase_II | Conjugation reactions increasing water solubility | Glucuronidation |
...
| mtDNA | Mitochondrial DNA | 16,569 bp circular |
| CYP | Cytochrome P450 | Metabolism enzymes |
...
| DDI | Drug-Drug Interaction | CYP-mediated |
| LD50 | Lethal Dose 50% | Toxicity measure |
| LC50 | Lethal Concentration 50% | Aquatic toxicity |
| NIEHS | National Institute of Environmental Health Sciences | NIH institute |
| EPA | Environmental Protection Agency | US regulator |
| CPDat | Chemical and Products Database | Exposure predictions |
| ToxCast | Toxicity Forecaster | Bioassay data |
| BFT | Byzantine Fault Tolerance | Not applicable here |
| PGx | Pharmacogenomics | Drug-gene variants |
| GWAS | Genome-Wide Association Study | Genetic variants |
| Pb | Lead | Heavy metal |
| Cd | Cadmium | Heavy metal |
| Hg | Mercury | Heavy metal |
| As | Arsenic | Heavy metal |
