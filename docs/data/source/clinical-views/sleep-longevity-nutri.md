---
id: domain-sleep-longevity-nutri
title: "Sleep, Longevity & Nutrigenomics Data Sources"
type: health-domain
parent: ../_index.md
...
|------|------------|---------|
| `SNP` | Single Nucleotide Polymorphism - variation at single DNA position | rs1801133 (MTHFR C677T) |
| `GWAS` | Genome-Wide Association Study - genome-wide variant-trait association | UK Biobank chronotype GWAS |
| `Circadian rhythm` | 24-hour biological cycle regulating sleep-wake and metabolism | CLOCK gene regulation |
| `Chronotype` | Individual's natural sleep-wake preference (morning/evening person) | 351 loci in GWAS Catalog |
| `Metabolite` | Small molecule intermediate or product of metabolism | HMDB 220K+ entries |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| `MTHFR` | Methylenetetrahydrofolate Reductase - key enzyme in folate metabolism | C677T, A1298C variants |
| `VDR` | Vitamin D Receptor - nuclear receptor for vitamin D signaling | rs2228570 (FokI) |
| `Cellular senescence` | Permanent cell growth arrest associated with aging | CellAge 866 genes |
| `Longevity genes` | Genes associated with extended lifespan across species | FOXO3, APOE, CETP |
| `Nutrigenomics` | Study of gene-nutrient interactions affecting health | NutriGenomeDB |
| `One-carbon metabolism` | Metabolic network involving folate and B12 for methylation | MTHFR, MTR, MTRR genes |
| `Dietary restriction` | Reduced calorie intake associated with longevity | GenDR 214 genes |
| `Senomorphic` | Compound that modulates senescent cells without killing them | DrugAge compounds |

### Acronyms

| Acronym | Expansion | Notes |
|---------|-----------|-------|
| HAGR | Human Ageing Genomic Resources | GenAge, LongevityMap, DrugAge suite |
| GenAge | Gene-Age database | 307 human aging genes |
| GenDR | Genes of Dietary Restriction | 214 DR-associated genes |
| HMDB | Human Metabolome Database | 220K+ metabolites |
| MTHFR | Methylenetetrahydrofolate Reductase | Key folate gene |
| VDR | Vitamin D Receptor | Vitamin D response gene |
| FT4 | Free Thyroxine | Thyroid hormone marker |
| TSH | Thyroid Stimulating Hormone | Pituitary thyroid hormone |
| dbNSFP | Database of Non-Synonymous Functional Predictions | 83M+ variants |
| nsSNV | Non-Synonymous Single Nucleotide Variant | Amino acid changing |
...
| eQTL | Expression Quantitative Trait Locus | Gene expression variants |
| pQTL | Protein Quantitative Trait Locus | Protein level variants |
