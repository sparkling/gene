...
<!--
  ETCM -> Unified Traditional Chinese Medicine Schema Mapping
  Source: ./schema.json
  Target: ../schema.json
  XSLT Version: 3.0
-->
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="fn:map">
    <fn:map>
      ...
      <fn:string key="pinyin"><xsl:value-of select="fn:string[@key='herb_name_pinyin']"/></fn:string>
      ...
      <fn:map key="_source">
        <fn:string key="database">ETCM</fn:string>
