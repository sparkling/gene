...
<!--
  ============================================================
  EFO -> Disease Ontologies Unified Schema Mapping
  ============================================================
  Source: ./schema.md (Experimental Factor Ontology)
  ...
  NOTES:
  - EFO uses EFO_####### format for IDs
  - Integrates terms from DO, HPO, ChEBI
  - Used by GWAS Catalog and Open Targets
-->
<xsl:stylesheet version="3.0"
  ...
  <xsl:template match="fn:map">
    <fn:map>
      ...
      <fn:map key="_source">
        <fn:string key="database">EFO</fn:string>
