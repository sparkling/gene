---
id: schema-fda-regulatory
title: "FDA Regulatory Data Schema"
type: schema
parent: _index.md
...
|------|------------|---------|
| `safetyreportid` | Unique 8-digit FDA adverse event report identifier | `10003214` |
| `RXCUI` | RxNorm Concept Unique Identifier for drug normalization | `861004` |
| `NDC` | National Drug Code - 10-digit drug product identifier | `0087-6060-01` |
| `UNII` | Unique Ingredient Identifier - 10 alphanumeric characters | `786Z46389E` |
| `set_id` | SPL Set ID - UUID grouping all versions of a drug label | `a1b2c3d4-e5f6-...` |
| `application_number` | FDA application number for approved drugs | `NDA020357` |
| `reactionmeddrapt` | MedDRA Preferred Term for adverse reaction | `Headache` |
| `drugcharacterization` | Role of drug in adverse event (1=suspect, 2=concomitant, 3=interacting) | `1` |
| `seriousnesshospitalization` | Flag indicating hospitalization required (1=yes) | `1` |
| `recall_number` | FDA enforcement recall identifier | `F-0879-2024` |
| `TE_Code` | Therapeutic equivalence code in Orange Book | `AB` |
| `NCT_ID` | ClinicalTrials.gov study identifier | `NCT01234567` |

### Domain-Specific Terms

| Term | Definition | Related To |
|------|------------|------------|
| FAERS | FDA Adverse Event Reporting System database | OpenFDA drug/event API |
| SPL | Structured Product Labeling - XML format for drug labels | DailyMed, set_id |
| RRF | Rich Release Format - pipe-delimited files for RxNorm | RXNCONSO, RXNREL |
| MedDRA | Medical Dictionary for Regulatory Activities | reactionmeddrapt |
| LOINC | Logical Observation Identifiers Names and Codes | SPL section codes |
| Orange Book | FDA publication of approved drug products with therapeutic equivalence | TE_Code, RLD |
| RLD | Reference Listed Drug - original approved version | Orange Book |
| Therapeutic Equivalence | FDA determination that generics can substitute for brand | A-rated, B-rated |
| Boxed Warning | Most serious FDA warning on drug labels | LOINC 34066-1 |
...
| NLM | National Library of Medicine | Maintains RxNorm, DailyMed |
| NDA | New Drug Application | Brand drug approval |
| ANDA | Abbreviated New Drug Application | Generic drug approval |
| BLA | Biologics License Application | Biologic drug approval |
| FAERS | FDA Adverse Event Reporting System | Post-market surveillance |
| SPL | Structured Product Labeling | XML label format |
| RRF | Rich Release Format | RxNorm file format |
| MedDRA | Medical Dictionary for Regulatory Activities | Adverse event coding |
| LOINC | Logical Observation Identifiers Names and Codes | Section code system |
...
| ATC | Anatomical Therapeutic Chemical Classification | Drug classification |
| UMLS | Unified Medical Language System | NLM metathesaurus |
| DUNS | Data Universal Numbering System | Organization identifier |
| UUID | Universally Unique Identifier | SPL document/set IDs |
| TTY | Term Type | RxNorm concept classification |
| GTIN | Global Trade Item Number | Product barcode standard |
